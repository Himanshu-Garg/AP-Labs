...
public class lab5 {
    ...
    public static abstract class negative_exception extends Exception {
    ...
    public static class NotOutofCage extends Exception {
        NotOutofCage() {
    ...
    public static class TrampolineException extends Exception {
    ...
    public static class GameWinnerException extends Exception {
        GameWinnerException() {
            super("Game won...");
        }
    }
    ...
    public static class race_track {
    ...
    public static class game_app {
        ...
        public game_app() {
            ...
            while (true) {
                System.out.println("PLS enter at-least 100");
                try {
